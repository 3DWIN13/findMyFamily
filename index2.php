...
<html lang="en">
  ...
  <div class="main-section">
    ...
    foreach ($us as $mostrar) { ?>
                <a href="#" class="dropdown-item"><i class="ion-ios-document mr-2"></i> </a>
    <?php } ?>
              </div>
            </li>
	...
	<!-- END nav -->
  	...
  	<section class="hero-wrap js-fullheight img" style="background-image: url(images/bg_3.jpg);">
  		...
  		<div class="container">
              ...
              <h4 class="mb-5">Debe iniciar sesión para llenar un formulario y localizar a tu pariente o conocido.</h4>
              <!-- el boton -->
               <button type="button" onclick="location.href='login.php'" class="btn btn-primary">Llenar informacion</button> 
  					</div>
  				</div>
  			</div>
  		</div>
